<form-control-choice-multiple>
  ...
  <div class="designer__group { is-edit-mode: showEditMode }">
    ...
    <div class="designer__form" if="{ !showEditMode }" onClick="{ toggleEditMode }">
      ...
      <div class="field-wrap">
        <select class="js-selectize-me" multiple">
          <option each="{ val in control.choices }">{ val.name }</option>
        </select>
  ...
  <script >
    ...
    this.selectizeOnMount = () => {
      const options = this.control.choices;
      const s = $(this.root.querySelector('.js-selectize-me')).selectize({
