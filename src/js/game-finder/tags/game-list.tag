...
<div class="row">
    <div class="col-sm-12" each={ testGames }>
        <div class="card sl-card text-white sl-bg-dark mt-4 mb-0">
            ...
            <div class="card-body p-0">
                ...
                <div class="sl-card-platforms">
                    <i if = {platforms.windows} class="fa fa-windows platform-icon"></i>
                    <i if = {platforms.mac}  class="fa fa-linux platform-icon"></i>
                    <i if = {platforms.linux}  class="fa fa-apple platform-icon"></i>
                </div>
            </div>
        </div>
    </div>
